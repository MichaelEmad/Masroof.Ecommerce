...
```
127.0.0.1 ecommerce-local-web
127.0.0.1 ecommerce-local-webgateway
127.0.0.1 ecommerce-local-authserver
```
...
Now, you can browse the URL: `https://ecommerce-local-web`
